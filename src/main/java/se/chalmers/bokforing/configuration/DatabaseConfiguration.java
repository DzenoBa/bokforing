 ...
 * so that you don't have to search through this class to find database
 * settings.
 *
 ...
 * database.
 *
 * The LocalContainerEntityManagerFactoryBean#setPackagesToScan method call
 * below sets where to look for classes tagged @Entity.
 *
 * @author Jakob
 */
@Configuration
...
public class DatabaseConfiguration {
    ...
    private Properties getJPAProperties() {
        ...
        // This injects the sql script into the database on startup, using the file
        // "schema.sql"
