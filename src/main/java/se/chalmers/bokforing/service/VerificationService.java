...
/**
 * Service for querying the database for verification entities. Note that this
 * interface must not provide any methods for deleting or updating, as this
 * would violate Swedish accounting laws.
 *
 * @author Jakob
 */
