...
public class CustomerController {
    ...
    public @ResponseBody FormJSON create(@RequestBody final CustomerJSON customer) {
    ...
    public @ResponseBody FormJSON edit(@RequestBody final CustomerJSON customer) {
    ...
    public @ResponseBody FormJSON delete(@RequestBody final CustomerJSON customer) {
