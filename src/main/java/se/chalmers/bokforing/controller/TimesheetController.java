...
public class TimesheetController {
    ...
    public @ResponseBody
    FormJSON create(@RequestBody final TimesheetJSON timesheet) {
    ...
    public @ResponseBody
    List<TimesheetJSON> getTimesheets(@RequestBody final TimesheetJSON timesheet) {
    ...
    public @ResponseBody
    FormJSON edit(@RequestBody final TimesheetJSON timesheet) {
    ...
    public @ResponseBody
    FormJSON delete(@RequestBody final TimesheetJSON timesheet) {
