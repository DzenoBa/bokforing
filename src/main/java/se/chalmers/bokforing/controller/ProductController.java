...
public class ProductController {
    ...
    public @ResponseBody
    FormJSON create(@RequestBody final ProductJSON product) {
    ...
    public @ResponseBody
    List<ProductJSON> getProducts(@RequestBody final ProductJSON product) {
    ...
    public @ResponseBody
    long countProducts(@RequestBody final ProductJSON product) {
    ...
    public @ResponseBody
    FormJSON edit(@RequestBody final ProductJSON product) {
    ...
    public @ResponseBody
    FormJSON delete(@RequestBody final ProductJSON product) {
